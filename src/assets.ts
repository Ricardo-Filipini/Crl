...
const VIDEO_PATH = '/Crl/Videos/';

// FIX: Added placeholder videos to resolve import error in VideoGallery.tsx
const CRL_VIDEO_1: CrlVideo = { src: `${VIDEO_PATH}crl-dancando.mp4` };
const CRL_VIDEO_2: CrlVideo = { src: `${VIDEO_PATH}crl-festa-barco.mp4` };
