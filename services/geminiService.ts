...
export const generateNickname = async (): Promise<string> => {
  try {
    const response = await ai.models.generateContent({
      ...
      contents: "Gere um apelido extremamente cafona e engraçado para um amigo chamado Carlos, que se acha o rei da balada. Use adjetivos inesperados. Seja criativo e zueiro. Retorne apenas o apelido, sem aspas, sem texto adicional, só o apelido puro.",
    });
